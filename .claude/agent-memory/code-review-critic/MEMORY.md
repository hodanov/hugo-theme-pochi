...
- [F-15 code-copy Chroma structure](review_f15_code_copy_chroma.md) — Chroma always produces 2-child spans; display:flex has no space; verify against actual build output
